...
- $$\Delta p_n$$ : offsets 일반적으로 분수다. 따라서 위치를 찾기 위해 위 식은 bilinear interpolation으로 구현된다.
...
![figure6](https://github.com/jjeamin/jjeamin.github.io/raw/master/_posts/post_img/dcn/figure6.PNG){: width="800" height="500"}{: .center}
